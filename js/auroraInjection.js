function injectAurora(){
  ...
  if (!injected) {
    frameContent.addEventListener("load", function() {
      ...
      bodyArea.insertAdjacentHTML('afterbegin','<div id="auroraWrapper" style="display:none;"><button onclick="speak()">Pause/Resume</button><div id="status"></div><div id="chart-container" onclick="wave.play()"></div></div>');
