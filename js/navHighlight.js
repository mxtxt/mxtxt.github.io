...
for (var i = 0; i < doc_btns.length; i++) {
  ...
  var current = doc_nav.getElementsByClassName("active");
  if (current.length > 0) {
...
for (var i = 0; i < theme_btns.length; i++) {
  ...
  var current = theme_nav.getElementsByClassName("active");
  if (current.length > 0) {
    current[0].className = current[0].className.replace(" active", "");
  }
  this.className += " active";
...
for (var i = 0; i < menu_btns.length; i++) {
  ...
  var current = menu_nav.getElementsByClassName("active");
  if (current.length > 0) {
    current[0].className = current[0].className.replace(" active", "");
  }
  this.className += " active";
